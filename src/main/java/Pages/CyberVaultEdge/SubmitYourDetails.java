...
public class SubmitYourDetails extends BaseTest {
    ...
    private MobileElement MandatoryDetailsByXpath;
    ...
    public SubmitYourDetails MandatoryDetails(){
        click(MandatoryDetailsByXpath);
        return this;
    }
    public SubmitYourDetails FirstName() throws InterruptedException {
        back();
        click(FirstNameByXpath);
        Thread.sleep(2000);
        back();
        sendKeys(FirstNameByXpath, "Aaaa");
        Thread.sleep(2000);
        return this;
    }
    public SubmitYourDetails LastName() throws InterruptedException{
        back();
        scrollToEnd();
        click(LastNameByXpath);
        Thread.sleep(2000);
        back();
        sendKeys(LastNameByXpath, "Abbbb");
        Thread.sleep(2000);
        back();
        return this;
    }
