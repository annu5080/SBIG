...
public class HealthQuestionare extends BaseTest {
    ...
    private MobileElement HaveCriticalIllnessById;
    @AndroidFindBy(accessibility = "NEXT")
    private MobileElement NextById;
    @AndroidFindBy(xpath = "(//android.widget.ImageView[@content-desc=\"YES\"])[1]")
    ...
    public HealthQuestionare HaveCriticalIllness(){
        click(HaveCriticalIllnessById);
        return this;
    }
