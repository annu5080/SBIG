...
//		server = getAppiumService(); // -> If using Mac, uncomment this statement and comment below statement
    ...
    public AppiumDriverLocalService getAppiumService() {
        ...
        environment.put("PATH", "C:/Users/AnnuShaw/AppData/Local/Android/Sdk/tools:C:/Users/AnnuShaw/AppData/Local/Android/Sdk/platform-tools:C:/Users/AnnuShaw/AppData/Local/Android/Sdk/platforms" + System.getenv("PATH"));
            ...
            switch(platformName) {
                case "Android":
                    ...
                    String androidAppUrl = System.getProperty("user.dir") + File.separator + "src" + File.separator + "main"
                            + File.separator + "resources" + File.separator + "apps" + File.separator + "sbig.apk";
