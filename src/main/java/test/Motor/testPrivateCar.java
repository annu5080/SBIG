...
public class testPrivateCar extends BaseTest {
    HomePage homePage;
    IntroPage introPage;
...
//    }
    ...
    public void IntroPage(){
        ...
        try {
            introPage.PrivateCar();
            utils.log().info("Clicked on Private Car");
            ExtentReportsSBIG.getTest().info("Clicked on Private Car");
            introPage.GetQuote();
    ...
    public void RegistrationNumber(){
        ...
        try {
            ...
            utils.log().info("Clicked and Entered 14");
            ExtentReportsSBIG.getTest().info("Clicked and Entered 14");
            registrationNumber.KA();
            utils.log().info("Clicked and Entered FS");
            ExtentReportsSBIG.getTest().info("Clicked and Entered FS");
            registrationNumber.Number2();
            utils.log().info("Clicked and Entered 1939");
            ExtentReportsSBIG.getTest().info("Clicked and Entered 1939");
    ...
    public void PolicyType(){
        ...
        try {
            ...
            policyType.InsuranceCompany();
            utils.log().info("Clicked and Entered Insurance Company name");
            ExtentReportsSBIG.getTest().info("Clicked and Entered Insurance Company name");
            policyType.SelectInsuranceCompany();
            utils.log().info("Selected Insurance Company as Care");
            ExtentReportsSBIG.getTest().info("Selected Insurance Company as Care");
            policyType.Next();
            utils.log().info("Clicked on Next Button");
            ExtentReportsSBIG.getTest().info("Clicked on Next Button");
        } catch (Exception e){
