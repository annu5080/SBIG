...
import Pages.Health.ArogyaSanjeevani.*;
...
public class testArogyaSanjeevani extends BaseTest {
    HomePage homePage;
    IntroPage introPage;
...
//    }
    ...
    public void IntroPage(){
        ...
        try{
            introPage.ArogyaSanjeevani();
            utils.log().info("Clicked on Arogya Sanjeevani");
            ExtentReportsSBIG.getTest().info("Clicked on Arogya Sanjeevani");
            introPage.GetQuote();
