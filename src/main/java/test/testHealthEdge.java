...
//    }
    ...
    public void personalDetails(){
        ...
        try {
            ...
            personalDetails.NegativeEmailAddress();
            utils.log().info("Negative test case");
            ExtentReportsSBIG.getTest().info("Negative test case");
            personalDetails.ClearInvalidEA();
            utils.log().info("______________________________________");
            ExtentReportsSBIG.getTest().info("______________________________________");
//            personalDetails.ClearInvalidEA();
//            utils.log().info("Negative test case cleared");
//            ExtentReportsSBIG.getTest().info("Negative test case cleared");
            personalDetails.EmailAddress();
            utils.log().info("Entered Email Address");
            ExtentReportsSBIG.getTest().info("Entered Email Address");

//            personalDetails.Demo();
//            utils.log().info("Practice_______________________");
//            ExtentReportsSBIG.getTest().info("Practice_______________________");
    ...
    public void InsuredDetails(){
        ...
        try {
            ...
            insuredDetails.Occupation();
            utils.log().info("Clicked on Type of Occupation");
            ExtentReportsSBIG.getTest().info("Clicked on Type of Occupation");
            insuredDetails.SelectOccupation();
